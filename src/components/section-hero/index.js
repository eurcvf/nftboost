  ...
  return (
    <section className="pt-36 bg-hero-pattern bg-no-repeat overflow-hidden">
      <ContainerGrid className="flex flex-col">
        ...
        <p className="w-full @desktop:max-w-content-desc-hero text-center text-sm @desktop:text-xl @tablet:text-base mb-6 @desktop:mb-9">Adentre um reino de possibilidades infinitas e mergulhe nas coleções de NFT, onde a arte, a cultura e a inovação se unem para criar experiências verdadeiramente exclusivas.</p>
